...
exports.deleteCat = exports.updateCat = exports.updateAllCat = exports.createCat = exports.readCat = exports.readAllcat = void 0;
...
var deleteCat = function (req, res) {
    try {
        var data_3 = req.params;
        var newCat = cats_model_1.Cat.filter(function (cat) { return cat.id === data_3.id; });
        res.status(200).send({
            success: true,
            data: newCat,
        });
